    ...
    <div class="col-lg-12">
        <div class="box">
            ...
            <div id="collapse2" class="body">
                <form class= "form-horizontal" action="<?php echo base_url('admin/add_data');?>" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="validate[required] form-control" name="tipe_mobil">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="validate[required] form-control" name="harga_mobil">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" min="1"  class="validate[required] form-control" name="kapasitas_penumpang">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" min="1"  class="validate[required] form-control" name="kapasitas_silinder">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <label for="gambar_url">
                                    <div class="fileinput-preview thumbnail" data-trigger="fileinput" >
                                 
                                        <img id="output" src = <?php echo base_url("assets/img/logo.png")?>  height='150' width='200'/>
                                    </div>
                                </label>
                                <input id="gambar_url" type="file"  name = gambar_url onchange="loadFile(event)" />
                            </div>
                        </div>
                    </div>
